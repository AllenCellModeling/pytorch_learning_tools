...
class model(nn.Module):
    ...
    def __init__(self, n_classes, nch, gpu_ids, opt=None):
        ...
        self.main = nn.Sequential(
            ...
            nn.BatchNorm3d(1024), nn.PReLU(), nn.Conv3d(1024, 1024, ksize, dstep, 1), nn.BatchNorm3d(1024), nn.PReLU())

        self.classOut = nn.Sequential(nn.Linear(1024 * int(self.fcsize * 1 * 1), self.n_classes))
